control 'AMZL-02-730710' do
  title 'The Amazon Linux 2 operating system must audit all uses of the newgrp command.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag gid: 'V-204550'
  tag rid: 'AMZL-02-730710r861047_rule'
  tag stig_id: 'AMZL-02-730710'
