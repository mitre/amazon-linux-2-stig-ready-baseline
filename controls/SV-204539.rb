control 'AMZL-02-730590' do
  title 'The Amazon Linux 2 operating system must audit all uses of the setfiles command.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag gid: 'V-204539'
  tag rid: 'AMZL-02-730590r861023_rule'
  tag stig_id: 'AMZL-02-730590'
