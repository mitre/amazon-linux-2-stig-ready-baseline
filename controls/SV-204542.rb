control 'AMZL-02-730630' do
  title 'The Amazon Linux 2 operating system must audit all uses of the passwd command.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag gid: 'V-204542'
  tag rid: 'AMZL-02-730630r861026_rule'
  tag stig_id: 'AMZL-02-730630'
