control 'AMZL-02-710492' do
  title 'Amazon Linux 2 operating systems booted with United Extensible Firmware Interface (UEFI) must have a unique name for the grub superusers account when booting into single-user mode and maintenance.'
...
$ sudo grep -iw "superusers" /boot/efi/EFI/amzn/grub.cfg
...
$ sudo grub2-mkconfig -o /boot/efi/EFI/amzn/grub.cfg'
  impact 0.5
  tag severity: 'medium'
