control 'AMZL-02-730570' do
  title 'The Amazon Linux 2 operating system must audit all uses of the setsebool command.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag gid: 'V-204537'
  tag rid: 'AMZL-02-730570r861017_rule'
  tag stig_id: 'AMZL-02-730570'
